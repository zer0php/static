class AsyncVueComponentLoader {
    ...
    static async load(container, mainJsElement, componentElements) {
        const componentLoader = new AsyncVueComponentLoader(container, componentElements);
    ...
    constructor(container, componentElements) {
